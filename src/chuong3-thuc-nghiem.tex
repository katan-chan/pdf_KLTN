...
% ............................................................
\subsection*{Tổng kết kết quả trên đồ thị sinh ngẫu nhiên}
\label{subsec:summary-synthetic}

Bốn mô hình sinh ngẫu nhiên cho một bức tranh nhất quán. $\lambda^*$ tối ưu nằm trong vùng nhỏ $\{0{,}5,\ 1\}$ trên Planted, SBM và GRPG, chỉ dịch lên đến $5$ trên các bộ LFR có cộng đồng tách yếu ($\mu \geq 0{,}35$). $\Delta Q$ luôn dương trên cả $35$ bộ test, nhưng biên độ cải thiện phụ thuộc trực tiếp vào độ tách cộng đồng của bộ sinh: trên các bộ test khó, $\Delta Q$ vượt $+0{,}3$; trên các bộ tách rõ, $\Delta Q$ gần như bằng $0$.

Cơ chế đứng sau hiện tượng này thống nhất giữa bốn mô hình: tam giác trên các đồ thị sinh ngẫu nhiên là hệ quả thống kê của mật độ cạnh chứ không độc lập với cạnh. Khi mật độ nội cụm $p_{\mathrm{in}}$ cao, số tam giác kỳ vọng trong cụm tỉ lệ với $p_{\mathrm{in}}^3$ và đã được phản ánh ngầm trong ma trận kề $A$. Do đó việc cộng thêm trọng số motif lớn không bổ sung tín hiệu mới mà chỉ pha loãng cấu trúc cạnh, khiến $\lambda^*$ tối ưu nằm ở vùng nhỏ. Trên hệ số phân cụm, $\overline{\mathrm{CC}}_w$ tăng đều với $\lambda$ và phản ánh đúng mức độ đóng kín tam giác trong cụm, trong khi $\overline{\mathrm{CC}}$ có thể bị đẩy lên cao tại $\lambda = W_M$ do các cụm nhỏ với hệ số phân cụm gần $1$ — một biểu hiện sớm của hiện tượng phân mảnh cụm sẽ thấy rõ hơn trên đồ thị thật. Phần kế tiếp xét xem các kết luận trên có còn đúng khi tam giác xuất hiện không phải do thống kê cạnh mà do một cơ chế xã hội độc lập.
...
% ............................................................
\subsection*{Tổng kết kết quả trên đồ thị thật}
\label{subsec:summary-real}
...
\textbf{Phụ thuộc theo $K$.} Trên cùng một đồ thị, biên độ cải thiện của $W_\lambda$ tăng đều theo $K$. Khi $K$ nhỏ, các cụm rộng và phân hoạch trên $A$ đã chứa phần lớn tam giác; trọng số motif khi đó không bổ sung thông tin và $\overline{\mathrm{CC}}_w$ gần như không thay đổi giữa $\lambda = 0$ và $\lambda^*$. Khi $K$ lớn, số tam giác bị cắt qua biên cụm tăng lên, và chính phần tam giác liên cụm này mới là tín hiệu mà $W_\lambda$ khai thác để gom các đỉnh chung tam giác về cùng cụm. Hiện tượng thấy rõ trên facebook\_combined ($\Delta Q$ từ $+0{,}006$ tại $K=50$ lên $+0{,}082$ tại $K=500$), CA-HepTh ($+0{,}001 \to +0{,}052$) và CA-GrQc ($+0{,}003 \to +0{,}048$). Nói ngắn gọn, motif chỉ phát huy vai trò khi yêu cầu phân hoạch chi tiết vượt khả năng của $A$ thuần.

\textbf{$G_\lambda$ so với $G_M$ thuần.} So sánh hai cực $\lambda^*$ hữu hạn và $\lambda = W_M$ cho thấy chúng tối ưu hai chỉ số khác nhau. $G_M$ cho $\overline{\mathrm{CC}}$ cao hơn rõ rệt trên đại đa số đồ thị (lastfm\_asia $0{,}27 \to 0{,}60$, CA-HepTh $0{,}53 \to 0{,}70$, musae\_facebook $0{,}45 \to 0{,}64$), nhưng đổi lại $Q$ thấp hơn nhiều: trên 9/10 đồ thị, $Q(W_M) < Q(\lambda^*)$ với khoảng cách có thể tới $0{,}10$--$0{,}15$. Nguyên nhân được giải thích ngay bởi Mệnh đề~\ref{prop:wlambda-fixes-gm} và thấy rõ qua $\overline{\mathrm{CC}}_w$: bỏ hoàn toàn $A$ khiến các đỉnh không thuộc tam giác bị cô lập trong $G_M$ và rơi vào cụm rất nhỏ, đẩy $\overline{\mathrm{CC}}$ lên cao do hiệu ứng cụm nhỏ chứ không do chất lượng phân hoạch thực sự cao hơn. $G_\lambda$ ở $\lambda$ hữu hạn giữ lại $A$ làm khung liên thông, hy sinh một phần $\overline{\mathrm{CC}}$ để đổi lấy $Q$ và phân hoạch không bị phân mảnh.
...
% ============================================================
\section{Tổng hợp: hai chế độ giá trị của $\lambda^*$}
