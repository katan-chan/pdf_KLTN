...
% ============================================================
\section{Các biến thể của bài toán phát hiện cộng đồng}
\label{sec:bien-the}
...
\textbf{Phát hiện cộng đồng chồng chéo} Trong nhiều mạng thực, một đỉnh có thể đồng thời thuộc nhiều cộng đồng. Khi đó bài toán không còn là phân hoạch tập đỉnh nữa mà là gán cho mỗi đỉnh một tập các cộng đồng mà nó thuộc về \cite{do2025overlap}.
...
% ============================================================
\section{Hướng tiếp cận của khoá luận}
\label{sec:huong-khoa-luan}
